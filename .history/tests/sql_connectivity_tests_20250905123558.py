"""Minimal stub for legacy SQL connectivity tests.

The heavy diagnostics have been removed. We keep interface compatibility so
imports in main application code continue to work without performing real
network operations. Restore previous version from VCS if needed.
"""
